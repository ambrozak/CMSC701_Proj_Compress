...
run_and_report \
    ...
    ../../src/query_index comp_ecoli$COMPSIZE.ind ../../data/ecoli20queries.txt

run_and_report \
    "Plain FM-index queries of len 20" \
    plain_20queries_results.txt \
    ../../src/query_plain_index plain_ecoli.ind ../../data/ecoli20queries.txt

run_and_report \
    "Compressed FM-index queries of len 50" \
    comp_50queries_results.txt \
    ../../src/query_index comp_ecoli$COMPSIZE.ind ../../data/ecoli50queries.txt

run_and_report \
    "Plain FM-index queries of len 50" \
    plain_50queries_results.txt \
    ../../src/query_plain_index plain_ecoli.ind ../../data/ecoli50queries.txt

run_and_report \
    "Compressed FM-index random queries" \
    comp_randomqueries_results.txt \
    ../../src/query_index comp_ecoli$COMPSIZE.ind ../../data/randomqueries.txt

run_and_report \
    "Plain FM-index random queries" \
    plain_randomqueries_results.txt \
    ../../src/query_plain_index plain_ecoli.ind ../../data/randomqueries.txt