...
run_and_report \
    ...
    ../../src/query_index comp_random$COMPSIZE.ind ../../data/random20queries.txt

run_and_report \
    "Plain FM-index queries of len 20" \
    plain_20queries_results.txt \
    ../../src/query_plain_index plain_random.ind ../../data/random20queries.txt

run_and_report \
    "Compressed FM-index queries of len 50" \
    comp_50queries_results.txt \
    ../../src/query_index comp_random$COMPSIZE.ind ../../data/random50queries.txt

run_and_report \
    "Plain FM-index queries of len 50" \
    plain_50queries_results.txt \
    ../../src/query_plain_index plain_random.ind ../../data/random50queries.txt

run_and_report \
    "Compressed FM-index random queries" \
    comp_randomqueries_results.txt \
    ../../src/query_index comp_random$COMPSIZE.ind ../../data/randomqueries.txt

run_and_report \
    "Plain FM-index random queries" \
    plain_randomqueries_results.txt \
    ../../src/query_plain_index plain_random.ind ../../data/randomqueries.txt